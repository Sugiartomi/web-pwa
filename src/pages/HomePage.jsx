        ...
        {userToken ? (
            ...
            >
              ...
              {userToken ? (
                statusPin ? (
                  ...
                  <div data-bs-toggle="modal" data-bs-target="#modal_pin_false">
                    {/* <img src={VoucherImg} alt="" className="img-fluid" /> */}
                    <div className="text-center mb-1">
                      <Upload03 />
                    </div>
          ...
          <>
            ...
            <p className="text-center text-white text-inter mt-2 font-12">
              Welcome! Get ready to experience a world of possibilities. Login
          ...
          >
            <div className="col-9">
              ...
              <p className="mb-0 font-12">
                Sorry for our beloved user, Our system had to maintenance till
                23:00 WIB
              </p>
            </div>
            <div className="col-3">
                    ...
                    >
                      <div className="d-flex mt-2 align-items-center">
                        ...
                        >
                          ...
                          {e.symbol.slice(e.symbol.length - 3, e.symbol.length)}
                        </div>
                      </div>
                      <div
                        className={
